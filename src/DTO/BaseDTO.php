...
//     /**
//      * Constructor: fill properties from array and validate required fields
//      *
...
//      *
//      * @param array<string, mixed> $data
//      * @param bool $checkRequired Check for required fields
//      * @return static
//      */
//     public function fill(array $data, bool $checkRequired = false): static
//     {
...
//     /**
//      * Validate required properties (no default value)
//      *
...
//     /**
//      * Magic setter for extra properties
//      */
//     public function __set(string $name, mixed $value): void
//     {
//         if (property_exists($this, $name)) {
...
//     /**
//      * Magic isset for extra properties
//      */
//     public function __isset(string $name): bool
//     {
//         return property_exists($this, $name) || isset($this->extra[$name]);
...
//     /**
//      * Magic unset for extra properties
//      */
//     public function __unset(string $name): void
//     {
//         if (property_exists($this, $name)) {
...
//     /**
//      * Convert DTO to array (include defined non-null + extra fields)
//      *
//      * @return array<string, mixed>
//      */
//     public function toArray(): array
