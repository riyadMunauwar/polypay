 ...
 *
 * Manages registration, retrieval, and instantiation of payment gateways.
...
//      *
//      * @throws GatewayNotFoundException If gateway not registered
//      * @throws \RuntimeException If the factory did not return a GatewayContract instance
//      */
//     public function get(string $name): GatewayContract
//     {
//         if (isset($this->instances[$name])) {
...
//     /**
//      * Get all registered gateway names OR instances.
//      *
//      * @param bool $asInstances If true, return resolved instances instead of names
//      * @return array
//      */
//     public function all(bool $asInstances = true): array
//     {
